...
1. The disease is not visible in either modality. The appropriate distribution is a bivariate $N_2$ distribution centered at $(0,0)$ with correlation $\rho_{00}$ whose pdf integrates to $(1-\alpha_1)(1-\alpha_2)$.  
    
1. The disease is visible in modality 1 but not visible in modality 2. The appropriate distribution is a bivariate $N_2$  distribution centered at $(\mu_{12},0)$ with correlation $\rho_{10}$ whose pdf integrates to $\alpha_1(1-\alpha_2)$.
    
1. The disease is not visible in modality 1 but is visible in modality 2. The appropriate distribution is a bivariate $N_2$ distribution centered at $(0,\mu_{22})$ with correlation $\rho_{01}$ whose pdf integrates to $(1-\alpha_1)\alpha_2$.
    
1. The disease is visible in both modalities 1 and 2. The appropriate distribution is a bivariate $N_2$ distribution centered at $(\mu_{12},\mu_{22})$ with correlation $\rho_{11}$ whose pdf integrates to $\alpha_1\alpha_2$.
...
In this equation $\text{pdf}$ denotes the bivariate normal pdf function with the specified mean-vectors and covariance matrices. Fig. \@ref(fig:bivariate-models-cbm-diseased) shows this pdf function as a surface plot in which four peaks are seen. This plot corresponds to the following values: $\mu_1 = 3.5$, $\mu_2 = 3$, $\rho_1 = 0.3$, $\rho_2 = 0.8$, $\alpha_1 = 0.5$ and $\alpha_2 = 0.6$. 
