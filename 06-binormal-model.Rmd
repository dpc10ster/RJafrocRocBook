...
```{r binormal-model-degeneracy-fig, fig.cap="Panels A, B and C illustrate that the exact fit is not unique. Panel D illustrates a reasonable unique fit to the data.", fig.show='hold', echo=FALSE}
