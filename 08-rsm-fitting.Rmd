...
The lesion distribution vector is `r lesDistr`. This means that fraction `r lesDistr[1]` of diseased cases contain one lesion, fraction `r lesDistr[2]` contain two lesions and fraction `r lesDistr[3]` contain three lesions.    
