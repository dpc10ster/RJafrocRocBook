...
<div class="figure">
<img src="08-rsm-fitting_files/figure-html/rsm-fitting-example-fit-1.png" alt="RSM-fitted ROC curve for treatment one and reader one of `dataset04`." width="672" />
<p class="caption">(\#fig:rsm-fitting-example-fit)RSM-fitted ROC curve for treatment one and reader one of `dataset04`.</p>
</div>
