...
\subsection{BGM ROC plots}\label{proper-roc-models-bigamma-code}}
...
Both RSM and CBM are implemented in \citep{R-RJafroc}. \texttt{PROPROC} is implemented in Windows software OR DBM-MRMC 2.5 \footnote{Sept.~04, 2014; the version used in this chapter is no longer distributed.} that was available \href{https://perception.lab.uiowa.edu/software}{here, last accessed 1/4/21}.
...
\section{TBA How much finished 20\%}\label{bivariate-binormal-model-how-much-finished}}
