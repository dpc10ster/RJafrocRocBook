...
\includegraphics{06-binormal-model_files/figure-latex/unnamed-chunk-14-1.pdf}
...
{\centering \includegraphics{06-binormal-model_files/figure-latex/binormal-model-degenerate-datasets-example1-1} 
...
{\centering \includegraphics{06-binormal-model_files/figure-latex/binormal-model-degenerate-datasets-example2-1} 
...
{\centering \includegraphics{06-binormal-model_files/figure-latex/binormal-model-degenerate-datasets-example3-1} 
...
{\centering \includegraphics{06-binormal-model_files/figure-latex/binormal-model-degenerate-reasonable-fit-1} 
...
\includegraphics{19c-improper-rocs_files/figure-latex/unnamed-chunk-2-1.pdf}

\begin{figure}
\centering
\includegraphics{19c-improper-rocs_files/figure-latex/improper-roc-reason-1.pdf}
\caption{\label{fig:improper-roc-reason}Reason for improper ROC}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{20a-proper-roc-models_files/figure-latex/proper-roc-models-plots-1-1.pdf}
...
\begin{figure}
\centering
\includegraphics{20a-proper-roc-models_files/figure-latex/proper-roc-models-plots-2-1.pdf}
...
\NormalTok{  plotRoc[[i]] }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(}
...
\begin{figure}
\centering
\includegraphics{20a-proper-roc-models_files/figure-latex/proper-roc-models-plots-3-1.pdf}
...
\begin{figure}
\centering
\includegraphics{20a-proper-roc-models_files/figure-latex/proper-roc-models-cbm-plots-1-1.pdf}
...
\begin{figure}
\centering
\includegraphics{20a-proper-roc-models_files/figure-latex/proper-roc-models-cbm-plots-2-1.pdf}
...
\begin{figure}
\centering
\includegraphics{20a-proper-roc-models_files/figure-latex/proper-roc-models-cbm-plots-3-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{rArray }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\FloatTok{4.391}\NormalTok{,}\DecValTok{5}\NormalTok{,}\DecValTok{10}\NormalTok{);lambdaArray }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\FloatTok{0.439}\NormalTok{,}\FloatTok{0.3}\NormalTok{,}\FloatTok{0.1}\NormalTok{)}
\CommentTok{\#r \textless{}{-}  4.391; lambda \textless{}{-}  0.439 \# from Dorfman paper}
\NormalTok{plotRoc }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{()}
\NormalTok{plotSlope }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{()}
\NormalTok{pdfs }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{()}
\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{1}\SpecialCharTok{:}\FunctionTok{length}\NormalTok{(rArray))}
\NormalTok{\{}
\NormalTok{  r }\OtherTok{\textless{}{-}}\NormalTok{ rArray[i];lambda }\OtherTok{\textless{}{-}}\NormalTok{ lambdaArray[i]}
\NormalTok{  AUC }\OtherTok{\textless{}{-}} \FunctionTok{integrate}\NormalTok{(aucIntegrand,}\DecValTok{0}\NormalTok{,}\DecValTok{1}\NormalTok{, }\AttributeTok{r =}\NormalTok{ r, }\AttributeTok{lambda =}\NormalTok{ lambda)}
...
\NormalTok{  x }\OtherTok{\textless{}{-}} \FunctionTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, r}\SpecialCharTok{/}\NormalTok{lambda }\SpecialCharTok{+} \DecValTok{10}\SpecialCharTok{*}\FunctionTok{sqrt}\NormalTok{(r}\SpecialCharTok{/}\NormalTok{lambda}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{), }\AttributeTok{by =} \FloatTok{0.01}\NormalTok{)}
\NormalTok{  FPF }\OtherTok{\textless{}{-}} \FunctionTok{biGammaRocY}\NormalTok{(x, r, }\DecValTok{1}\NormalTok{)}
\NormalTok{  TPF }\OtherTok{\textless{}{-}} \FunctionTok{biGammaRocY}\NormalTok{(x, r, lambda)}
...
\NormalTok{           LETTERS[i], }
           \StringTok{":"}\NormalTok{, }
           \FunctionTok{sprintf}\NormalTok{(}\StringTok{" r = \%3.2f, lambda = \%3.2f"}\NormalTok{, }
\NormalTok{                   r, lambda)))}
...
\begin{figure}
\centering
\includegraphics{20a-proper-roc-models_files/figure-latex/proper-roc-models-bigamma-plots-1-1.pdf}
...
\begin{figure}
\centering
\includegraphics{20a-proper-roc-models_files/figure-latex/proper-roc-models-bigamma-plots-2-1.pdf}
...
\begin{figure}
\centering
\includegraphics{20a-proper-roc-models_files/figure-latex/proper-roc-models-bigamma-plots-3-1.pdf}
...
\includegraphics{20b-proproc-roc-curves_files/figure-latex/unnamed-chunk-2-1.pdf} \includegraphics{20b-proproc-roc-curves_files/figure-latex/unnamed-chunk-2-2.pdf} \includegraphics{20b-proproc-roc-curves_files/figure-latex/unnamed-chunk-2-3.pdf} \includegraphics{20b-proproc-roc-curves_files/figure-latex/unnamed-chunk-2-4.pdf}
