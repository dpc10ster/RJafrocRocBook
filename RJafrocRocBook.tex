...
Both RSM and CBM are implemented in R-package \texttt{RJafroc} \citep{R-RJafroc}. \texttt{PROPROC} is implemented in Windows software OR DBM-MRMC 2.5 \footnote{Sept.~04, 2014; the version used in this chapter is no longer distributed.} that was available \href{https://perception.lab.uiowa.edu/software}{here, last accessed 1/4/21}. The PROPROC results-file locations are shown in \ref{rsm-3-fits-one-dataset-proproc}.
