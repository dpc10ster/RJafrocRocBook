...
\NormalTok{mu }\OtherTok{\textless{}{-}} \DecValTok{3}\NormalTok{;sigma }\OtherTok{\textless{}{-}} \DecValTok{1}
\NormalTok{zeta }\OtherTok{\textless{}{-}} \DecValTok{1}
\NormalTok{step }\OtherTok{\textless{}{-}} \FloatTok{0.1}

\NormalTok{lowerLimit}\OtherTok{\textless{}{-}} \SpecialCharTok{{-}}\DecValTok{1} \CommentTok{\# lower limit}
\NormalTok{upperLimit }\OtherTok{\textless{}{-}}\NormalTok{ mu }\SpecialCharTok{+} \DecValTok{3}\SpecialCharTok{*}\NormalTok{sigma }\CommentTok{\# upper limit}

\NormalTok{z }\OtherTok{\textless{}{-}} \FunctionTok{seq}\NormalTok{(lowerLimit, upperLimit, }\AttributeTok{by =}\NormalTok{ step)}
\NormalTok{pdfs }\OtherTok{\textless{}{-}} \FunctionTok{dnorm}\NormalTok{(z)}
\NormalTok{seqNor }\OtherTok{\textless{}{-}} \FunctionTok{seq}\NormalTok{(zeta,upperLimit,step)}
\NormalTok{cord.x }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(zeta, seqNor,upperLimit) }
\CommentTok{\# need two y{-}coords at each end point of range; }
\CommentTok{\# one at zero and one at value of function}
\NormalTok{cord.y }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\FunctionTok{dnorm}\NormalTok{(seqNor),}\DecValTok{0}\NormalTok{) }
...
\NormalTok{shadeData }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{z =}\NormalTok{ cord.x, }\AttributeTok{pdfs =}\NormalTok{ cord.y)}
\NormalTok{shadedPlots }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(}\AttributeTok{mapping =} \FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ z, }\AttributeTok{y =}\NormalTok{ pdfs)) }\SpecialCharTok{+} 
  \FunctionTok{geom\_line}\NormalTok{(}\AttributeTok{data =}\NormalTok{ curveData, }\AttributeTok{color =} \StringTok{"blue"}\NormalTok{) }\SpecialCharTok{+} 
  \FunctionTok{geom\_polygon}\NormalTok{(}\AttributeTok{data =}\NormalTok{ shadeData, }\AttributeTok{color =} \StringTok{"blue"}\NormalTok{, }\AttributeTok{fill =} \StringTok{"blue"}\NormalTok{)}

\NormalTok{crossing }\OtherTok{\textless{}{-}} \FunctionTok{uniroot}\NormalTok{(}\ControlFlowTok{function}\NormalTok{(x) }\FunctionTok{dnorm}\NormalTok{(x) }\SpecialCharTok{{-}} \FunctionTok{dnorm}\NormalTok{(x,mu,sigma), }
                    \AttributeTok{lower =} \DecValTok{0}\NormalTok{, }\AttributeTok{upper =} \DecValTok{3}\NormalTok{)}\SpecialCharTok{$}\NormalTok{root}
\NormalTok{crossing }\OtherTok{\textless{}{-}} \FunctionTok{max}\NormalTok{(}\FunctionTok{c}\NormalTok{(zeta, crossing))}
\NormalTok{seqAbn }\OtherTok{\textless{}{-}} \FunctionTok{seq}\NormalTok{(crossing,upperLimit,step)}
\NormalTok{cord.x }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(seqAbn, }\FunctionTok{rev}\NormalTok{(seqAbn))}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mu }\OtherTok{\textless{}{-}} \FloatTok{1.5}
\NormalTok{zeta }\OtherTok{\textless{}{-}}\NormalTok{ mu}\SpecialCharTok{/}\DecValTok{2}
\NormalTok{seed }\OtherTok{\textless{}{-}} \DecValTok{100} \CommentTok{\# line 4}
\NormalTok{K1 }\OtherTok{\textless{}{-}} \DecValTok{9}
\NormalTok{K2 }\OtherTok{\textless{}{-}} \DecValTok{11}
\NormalTok{ds }\OtherTok{\textless{}{-}} \FunctionTok{simulateDataset}\NormalTok{(K1, K2, mu, zeta, seed)}

\FunctionTok{cat}\NormalTok{(}\StringTok{"seed = "}\NormalTok{, seed, }
    ...
    \StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{Specificity = "}\NormalTok{, ds}\SpecialCharTok{$}\NormalTok{Sp, }
    \StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{Sensitivity = "}\NormalTok{, ds}\SpecialCharTok{$}\NormalTok{Se, }
    \StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{Est. of mu = "}\NormalTok{, ds}\SpecialCharTok{$}\NormalTok{mu, }\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{seed }\OtherTok{\textless{}{-}} \DecValTok{101} \CommentTok{\# change}
\NormalTok{ds }\OtherTok{\textless{}{-}} \FunctionTok{simulateDataset}\NormalTok{(K1, K2, mu, zeta, seed)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{K1 }\OtherTok{\textless{}{-}} \DecValTok{90} \CommentTok{\# change}
\NormalTok{K2 }\OtherTok{\textless{}{-}} \DecValTok{110} \CommentTok{\# change}
\NormalTok{seed }\OtherTok{\textless{}{-}} \DecValTok{100} \CommentTok{\# change}
\NormalTok{ds }\OtherTok{\textless{}{-}} \FunctionTok{simulateDataset}\NormalTok{(K1, K2, mu, zeta, seed)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{results }\OtherTok{\textless{}{-}} \FunctionTok{array}\NormalTok{(}\AttributeTok{dim =} \FunctionTok{c}\NormalTok{(}\DecValTok{9}\NormalTok{,}\DecValTok{6}\NormalTok{))}
\NormalTok{mu }\OtherTok{\textless{}{-}} \FloatTok{1.5}
\NormalTok{zeta }\OtherTok{\textless{}{-}}\NormalTok{ mu}\SpecialCharTok{/}\DecValTok{2}
\NormalTok{results[}\DecValTok{9}\NormalTok{,] }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\ConstantTok{Inf}\NormalTok{, }\ConstantTok{Inf}\NormalTok{, }\ConstantTok{NA}\NormalTok{, }\FunctionTok{pnorm}\NormalTok{(zeta), }\FunctionTok{pnorm}\NormalTok{(mu}\SpecialCharTok{{-}}\NormalTok{zeta), mu)}
\NormalTok{K1\_arr }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\DecValTok{9}\NormalTok{, }\DecValTok{9}\NormalTok{, }\DecValTok{90}\NormalTok{, }\DecValTok{90}\NormalTok{, }\DecValTok{900}\NormalTok{, }\DecValTok{900}\NormalTok{, }\DecValTok{9000}\NormalTok{, }\DecValTok{9000}\NormalTok{, }\ConstantTok{NA}\NormalTok{)}
\NormalTok{K2\_arr }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\DecValTok{11}\NormalTok{, }\DecValTok{11}\NormalTok{, }\DecValTok{110}\NormalTok{, }\DecValTok{110}\NormalTok{, }\DecValTok{1100}\NormalTok{, }\DecValTok{1100}\NormalTok{, }\DecValTok{11000}\NormalTok{, }\DecValTok{11000}\NormalTok{, }\ConstantTok{NA}\NormalTok{)}
\NormalTok{seed\_arr }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\DecValTok{100}\NormalTok{,}\DecValTok{101}\NormalTok{,}\DecValTok{100}\NormalTok{,}\DecValTok{101}\NormalTok{,}\DecValTok{100}\NormalTok{,}\DecValTok{101}\NormalTok{,}\DecValTok{100}\NormalTok{,}\DecValTok{101}\NormalTok{,}\ConstantTok{NA}\NormalTok{)}
\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{1}\SpecialCharTok{:}\DecValTok{8}\NormalTok{) \{}
\NormalTok{  ds }\OtherTok{\textless{}{-}} \FunctionTok{simulateDataset}\NormalTok{(K1\_arr[i], K2\_arr[i], mu, zeta, seed\_arr[i])}
\NormalTok{  results[i,] }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(K1\_arr[i], K2\_arr[i], seed\_arr[i], ds}\SpecialCharTok{$}\NormalTok{Sp, ds}\SpecialCharTok{$}\NormalTok{Se, ds}\SpecialCharTok{$}\NormalTok{mu)}
\NormalTok{\}}
\NormalTok{df }\OtherTok{\textless{}{-}} \FunctionTok{as.data.frame}\NormalTok{(results)}
\FunctionTok{colnames}\NormalTok{(df) }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"K1"}\NormalTok{,}\StringTok{"K2"}\NormalTok{,}\StringTok{"seed"}\NormalTok{,}\StringTok{"Se"}\NormalTok{,}\StringTok{"Sp"}\NormalTok{,}\StringTok{"mu"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{ret }\OtherTok{\textless{}{-}} \FunctionTok{binom.test}\NormalTok{(nTN, K1, }\AttributeTok{p =}\NormalTok{ nTN}\SpecialCharTok{/}\NormalTok{K1)}
\FunctionTok{cat}\NormalTok{(}\StringTok{"Exact 95percent CI on Specificity = "}\NormalTok{, }
    \FunctionTok{as.numeric}\NormalTok{(ret}\SpecialCharTok{$}\NormalTok{conf.int),}\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
\CommentTok{\#\textgreater{} Exact 95percent CI on Specificity =  0.945 1}

\CommentTok{\# Approx binomial tests}
\FunctionTok{cat}\NormalTok{(}\StringTok{"approx 95percent CI on Sensitivity = "}\NormalTok{, }
    \SpecialCharTok{{-}}\FunctionTok{abs}\NormalTok{(}\FunctionTok{qnorm}\NormalTok{(alpha}\SpecialCharTok{/}\DecValTok{2}\NormalTok{))}\SpecialCharTok{*}\FunctionTok{sqrt}\NormalTok{(Se}\SpecialCharTok{*}\NormalTok{(}\DecValTok{1}\SpecialCharTok{{-}}\NormalTok{Se)}\SpecialCharTok{/}\NormalTok{K2)}\SpecialCharTok{+}\NormalTok{Se, }
    \SpecialCharTok{+}\FunctionTok{abs}\NormalTok{(}\FunctionTok{qnorm}\NormalTok{(alpha}\SpecialCharTok{/}\DecValTok{2}\NormalTok{))}\SpecialCharTok{*}\FunctionTok{sqrt}\NormalTok{(Se}\SpecialCharTok{*}\NormalTok{(}\DecValTok{1}\SpecialCharTok{{-}}\NormalTok{Se)}\SpecialCharTok{/}\NormalTok{K2)}\SpecialCharTok{+}\NormalTok{Se,}\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
\CommentTok{\#\textgreater{} approx 95percent CI on Sensitivity =  0.973 1.01}

\CommentTok{\# Exact binomial test}
\NormalTok{ret }\OtherTok{\textless{}{-}} \FunctionTok{binom.test}\NormalTok{(nTP, K2, }\AttributeTok{p =}\NormalTok{ nTP}\SpecialCharTok{/}\NormalTok{K2)}
\FunctionTok{cat}\NormalTok{(}\StringTok{"Exact 95percent CI on Sensitivity = "}\NormalTok{, }
    \FunctionTok{as.numeric}\NormalTok{(ret}\SpecialCharTok{$}\NormalTok{conf.int),}\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
...
\NormalTok{ROCPlot }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(}
  ...
  \FunctionTok{annotation\_custom}\NormalTok{(}
    ...
    \AttributeTok{xmin =} \SpecialCharTok{{-}}\FloatTok{0.03}\NormalTok{, }\AttributeTok{xmax =} \SpecialCharTok{{-}}\FloatTok{0.03}\NormalTok{, }
    \AttributeTok{ymin =} \SpecialCharTok{{-}}\FloatTok{0.03}\NormalTok{, }\AttributeTok{ymax =} \SpecialCharTok{{-}}\FloatTok{0.03}\NormalTok{) }\SpecialCharTok{+} 
  \FunctionTok{annotation\_custom}\NormalTok{(}
    \AttributeTok{grob =} \FunctionTok{textGrob}\NormalTok{(}\FunctionTok{bquote}\NormalTok{(}\FunctionTok{italic}\NormalTok{(O[}\DecValTok{4}\NormalTok{])),}
                    \AttributeTok{gp =} \FunctionTok{gpar}\NormalTok{(}\AttributeTok{fontsize =} \DecValTok{22}\NormalTok{)), }
    \AttributeTok{xmin =} \FloatTok{0.06}\NormalTok{, }\AttributeTok{xmax =} \FloatTok{0.06}\NormalTok{, }
    \AttributeTok{ymin =} \FloatTok{0.40}\NormalTok{, }\AttributeTok{ymax =} \FloatTok{0.40}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{annotation\_custom}\NormalTok{(}
    \AttributeTok{grob =} \FunctionTok{textGrob}\NormalTok{(}\FunctionTok{bquote}\NormalTok{(}\FunctionTok{italic}\NormalTok{(O[}\DecValTok{3}\NormalTok{])),}
                    \AttributeTok{gp =} \FunctionTok{gpar}\NormalTok{(}\AttributeTok{fontsize =} \DecValTok{22}\NormalTok{)), }
    \AttributeTok{xmin =} \FloatTok{0.10}\NormalTok{, }\AttributeTok{xmax =} \FloatTok{0.10}\NormalTok{, }
    \AttributeTok{ymin =} \FloatTok{0.64}\NormalTok{, }\AttributeTok{ymax =} \FloatTok{0.64}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{annotation\_custom}\NormalTok{(}
    \AttributeTok{grob =} \FunctionTok{textGrob}\NormalTok{(}\FunctionTok{bquote}\NormalTok{(}\FunctionTok{italic}\NormalTok{(O[}\DecValTok{2}\NormalTok{])),}
                    \AttributeTok{gp =} \FunctionTok{gpar}\NormalTok{(}\AttributeTok{fontsize =} \DecValTok{22}\NormalTok{)), }
    \AttributeTok{xmin =} \FloatTok{0.16}\NormalTok{, }\AttributeTok{xmax =} \FloatTok{0.16}\NormalTok{, }
    \AttributeTok{ymin =} \FloatTok{0.83}\NormalTok{, }\AttributeTok{ymax =} \FloatTok{0.83}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{annotation\_custom}\NormalTok{(}
    \AttributeTok{grob =} \FunctionTok{textGrob}\NormalTok{(}\FunctionTok{bquote}\NormalTok{(}\FunctionTok{italic}\NormalTok{(O[}\DecValTok{1}\NormalTok{])),}
                    \AttributeTok{gp =} \FunctionTok{gpar}\NormalTok{(}\AttributeTok{fontsize =} \DecValTok{22}\NormalTok{)), }
    \AttributeTok{xmin =} \FloatTok{0.49}\NormalTok{, }\AttributeTok{xmax =} \FloatTok{0.49}\NormalTok{, }
    \AttributeTok{ymin =} \FloatTok{0.94}\NormalTok{, }\AttributeTok{ymax =} \FloatTok{0.94}\NormalTok{)  }

\NormalTok{p }\OtherTok{\textless{}{-}} \FunctionTok{ggplotGrob}\NormalTok{(ROCPlot)}
\NormalTok{p}\SpecialCharTok{$}\NormalTok{layout}\SpecialCharTok{$}\NormalTok{clip[p}\SpecialCharTok{$}\NormalTok{layout}\SpecialCharTok{$}\NormalTok{name}\SpecialCharTok{==}\StringTok{"panel"}\NormalTok{] }\OtherTok{\textless{}{-}} \StringTok{"off"}
\FunctionTok{grid.draw}\NormalTok{(p)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{RocDataTable }\OtherTok{=} \FunctionTok{array}\NormalTok{(}\AttributeTok{dim =} \FunctionTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{,}\DecValTok{4}\NormalTok{))}
\NormalTok{RocDataTable[}\DecValTok{1}\NormalTok{,]  }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\DecValTok{30}\NormalTok{,}\DecValTok{19}\NormalTok{,}\DecValTok{8}\NormalTok{,}\DecValTok{3}\NormalTok{)}
\NormalTok{RocDataTable[}\DecValTok{2}\NormalTok{,]  }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\DecValTok{5}\NormalTok{,}\DecValTok{11}\NormalTok{,}\DecValTok{12}\NormalTok{,}\DecValTok{22}\NormalTok{)}

\NormalTok{ret  }\OtherTok{\textless{}{-}} \FunctionTok{RocOperatingPointsFromRatingsTable}\NormalTok{( }
\NormalTok{  RocDataTable[}\DecValTok{1}\NormalTok{,], }
\NormalTok{  RocDataTable[}\DecValTok{2}\NormalTok{,] )}
\NormalTok{FPF }\OtherTok{\textless{}{-}}\NormalTok{ ret}\SpecialCharTok{$}\NormalTok{FPF}
\NormalTok{TPF }\OtherTok{\textless{}{-}}\NormalTok{ ret}\SpecialCharTok{$}\NormalTok{TPF}

\NormalTok{ROC\_Points }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{FPF =}\NormalTok{ FPF, }\AttributeTok{TPF =}\NormalTok{ TPF)}
\CommentTok{\# add the trivial points}
\NormalTok{ROC\_Points }\OtherTok{\textless{}{-}} \FunctionTok{rbind}\NormalTok{(}
  \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{0}\NormalTok{), }
\NormalTok{  ROC\_Points, }\FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{1}\NormalTok{))}

\NormalTok{shade }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}
  \AttributeTok{FPF =} \FunctionTok{c}\NormalTok{(ROC\_Points}\SpecialCharTok{$}\NormalTok{FPF, }\DecValTok{1}\NormalTok{), }
  \AttributeTok{TPF =} \FunctionTok{c}\NormalTok{(ROC\_Points}\SpecialCharTok{$}\NormalTok{TPF, }\DecValTok{0}\NormalTok{))}
...
\NormalTok{retFit[}\DecValTok{1}\SpecialCharTok{:}\DecValTok{5}\NormalTok{]}
