...
```{r empirical-auc-empirical-plot, fig.cap="Empirical ROC plot for the data in Table 4.1. By convention the operating points are numbered starting with the uppermost non-trivial one and working down the plot and the trivial operating points (0,0) and (1,1) are not shown."}
K1 <- 60
K2 <- 50
